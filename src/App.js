  ...
  return (
    <div className="h-screen bg-black/80 flex items-center justify-center">
      <div className="max-w-2xl mx-auto bg-black/40 text-white flex flex-col md:flex-row rounded-lg items-center">
        <div className="w-full md:w-64 p-6 md:p-3">
          <img src={image6} alt="plant" className="w-full  my-3 md:my-0 h-64 rounded-l-lg transform hover:scale-110 hover:rounded-lg duration-300"/>
        </div>
